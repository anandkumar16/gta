        ...
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          <div className="landing overflow-hidden relative w-full h-screen bg-black">
            ...
            <div className="imagesdiv relative overflow-hidden w-full h-screen">
              ...
              <img
                className="absolute character left-1/2 -translate-x-1/2 scale-[1.5] sm:scale-[1.8] md:scale-[2] lg:scale-[2.2] xl:scale-[2.4] bottom-0 sm:bottom-[-10%] md:bottom-[-15%] lg:bottom-[-18%] rotate-[-20deg] max-h-[70vh] max-w-[80vw]"
                src="./girlbg.png"
                alt=""
              />
            </div>
          ...
          <div className="w-full min-h-screen bg-black overflow-hidden">
            <div className="cntnr flex text-white w-full h-[80%] ">
              <div className="limg relative w-1/2 h-full">
                <img
                  className="absolute scale-[1.3] top-1/2 left-1/2 -translate-x-1/2 -translate-y-[5%]"
                  src="./imag.png"
                  alt=""
                />
              </div>
              <div className="rg w-[30%] py-30">
                ...
                in the middle of a criminal conspiracy stretching across the state of Leonida — 
